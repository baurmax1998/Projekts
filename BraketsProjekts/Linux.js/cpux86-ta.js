...
function CPU_X86_EXEC(ja, ka, la) {
    ...
    function Bb(aa) {
        ...
        var zb = 0
            , da = 0;
        zb = Ya[(Ua + ((aa >>> 12) << 2)) >> 2] | 0;
        if ((zb | aa) & 1) da = Ab(aa) | 0;
        else da = Xa[(aa ^ zb) >> 1] | 0;
        return da | 0;
    }
    ...
    function Db(aa) {
        ...
        var da = 0;
        zb = Ya[(Ua + ((aa >>> 12) << 2)) >> 2] | 0;
        if ((zb | aa) & 3) da = Cb(aa) | 0;
        else da = Ya[(aa ^ zb) >> 2] | 0;
        return da | 0;
    }
    ...
    function Hb(aa) {
        ...
        var wb = 0
            , da = 0;
        wb = Ya[(Va + ((aa >>> 12) << 2)) >> 2] | 0;
        if ((wb | aa) & 1) da = Gb(aa) | 0;
        else da = Xa[(aa ^ wb) >> 1] | 0;
        return da | 0;
    }
    ...
    function Jb(aa) {
        ...
        var wb = 0
            , da = 0;
        wb = Ya[(Va + ((aa >>> 12) << 2)) >> 2] | 0;
        if ((wb | aa) & 3) da = Ib(aa) | 0;
        else da = Ya[(aa ^ wb) >> 2] | 0;
        return da | 0;
    }
    ...
    function oe(pe) {
        ...
        kc = pe & ~7;
        if (((kc + 7) | 0) > (Ya[(((ha) << 4) + (128 + 8)) >> 2] | 0)) return 0;
    ...
    function ve() {
        Ia = (Ya[(((1) << 4) + (128 + 4)) >> 2] | 0);
        Ja = (Ya[(((2) << 4) + (128 + 4)) >> 2] | 0);
        if ((Ya[(((2) << 4) + (128 + 12)) >> 2] | 0) & (1 << 22)) Ka = -1;
        else Ka = 65535;
        La = (((Ia | Ja | (Ya[(((3) << 4) + (128 + 4)) >> 2] | 0) | (Ya[(((0) << 4) + (128 + 4)) >> 2] | 0)) == 0) & (Ka | 0) == -1);
        if ((Ya[(((1) << 4) + (128 + 12)) >> 2] | 0) & (1 << 22)) Ma = 0;
        else Ma = 256 | 128;
        Sa = (Oa + 8192) & ~4095;
    }
    ...
    function Ae(Be) {
        ...
        var Ce = 0
            ...
            , wb = 0
            , aa = 0;
        if (!((Ya[(((7) << 4) + (128 + 12)) >> 2] | 0) & (1 << 15))) fb(201);
        Ce = ((Ya[(((7) << 4) + (128 + 12)) >> 2] | 0) >> 8) & 15;
        if ((Ce & 7) != 1) fb(204);
        De = Ce >> 3;
        kc = ((Be << 2) + 2) << De;
        wb = (kc + (4 << De) - 1) | 0;
        if ((wb >>> 0) > ((Ya[(((7) << 4) + (128 + 8)) >> 2] | 0) >>> 0)) fe(10, (Ya[(((7) << 4) + (128 + 0)) >> 2] | 0) & 65532);
    ...
    function Ge(He, Ie, Zd, Je, Ke) {
        ...
        if (((He << 3) | 7) > (Ya[(((9) << 4) + (128 + 8)) >> 2] | 0)) fe(13, (He << 3) | 2);
        ...
        Be = (ne >> 13) & 3;
        Ne = sa;
        if (((Ie | 0) != 0) & (Be | 0) < (Ne | 0)) fe(13, (He << 3) | 2);
        if (!(ne & (1 << 15))) fe(11, (He << 3) | 2);
        pe = qe >> 16;
        Qe = (ne & -65536) | (qe & 65535);
        if ((pe & 65532) == 0) fe(13, 0);
        e = oe(pe) | 0;
        if (!e) fe(13, pe & 65532);
        qe = Ga;
        ne = Ha;
        if (!(ne & (1 << 12)) | !(ne & ((1 << 11)))) fe(13, pe & 65532);
        Be = (ne >> 13) & 3;
        if ((Be | 0) > (Ne | 0)) fe(13, pe & 65532);
        if (!(ne & (1 << 15))) fe(11, pe & 65532);
        if (!(ne & (1 << 10)) & (Be | 0) < (Ne | 0)) {
            Fe = Ae(Be) | 0;
            Ee = Ga;
            if ((Ee & 65532) == 0) fe(10, Ee & 65532);
            if ((Ee & 3) != (Be | 0)) fe(10, Ee & 65532);
            e = oe(Ee) | 0;
            if (!e) fe(10, Ee & 65532);
            Re = Ga;
            Se = Ha;
            Me = (Se >> 13) & 3;
            if ((Me | 0) != (Be | 0)) fe(10, Ee & 65532);
            if (!(Se & (1 << 12)) | !!(Se & (1 << 11)) | !(Se & (1 << 9))) fe(10, Ee & 65532);
            if (!(Se & (1 << 15))) fe(10, Ee & 65532);
            Pe = 1;
            Ka = me(Se) | 0;
            Le = te(Re, Se) | 0;
        } else if (!!(ne & (1 << 10)) | (Be | 0) == (Ne | 0)) {
            if (ta & 131072) fe(13, pe & 65532);
            Pe = 0;
    ...
    function Ue(He, Ie, Zd, Je, Ke) {
        ...
        var Le = 0
            ...
            , Te = 0
            , aa = 0;
        if (((He << 2) | 3) > (Ya[(((9) << 4) + (128 + 8)) >> 2] | 0)) fe(13, (He << 3) | 2);
    ...
    function We(pe) {
        ...
        if ((pe & 65532) == 0) {
            ...
            if (pe & 4) fe(13, pe & 65532);
            kc = pe & ~7;
            Xe = 7;
            if (((kc + Xe) >>> 0) > ((Ya[(((8) << 4) + (128 + 8)) >> 2] | 0) >>> 0)) fe(13, pe & 65532);
            aa = ((Ya[(((8) << 4) + (128 + 4)) >> 2] | 0) + kc) | 0;
            qe = Vb(aa) | 0;
            aa = (aa + 4) | 0;
            ne = Vb(aa) | 0;
            if (!!(ne & (1 << 12)) | ((ne >> 8) & 15) != 2) fe(13, pe & 65532);
            if (!(ne & (1 << 15))) fe(11, pe & 65532);
            ue(6, qe, ne);
        }
        Ya[(((6) << 4) + (128 + 0)) >> 2] = pe;
    ...
    function Ye(pe) {
        ...
        if ((pe & 65532) == 0) {
            ...
            if (pe & 4) fe(13, pe & 65532);
            kc = pe & ~7;
            if (((kc | 7) >>> 0) > ((Ya[(((8) << 4) + (128 + 8)) >> 2] | 0) >>> 0)) fe(13, pe & 65532);
            aa = ((Ya[(((8) << 4) + (128 + 4)) >> 2] | 0) + kc) | 0;
            qe = Vb(aa) | 0;
            aa = (aa + 4) | 0;
            ne = Vb(aa) | 0;
            Ce = (ne >> 8) & 15;
            if (!!(ne & (1 << 12)) | ((Ce | 0) != 1 & (Ce | 0) != 9)) fe(13, pe & 65532);
            if (!(ne & (1 << 15))) fe(11, pe & 65532);
            ue(7, qe, ne);
            ne = ne | (1 << 9);
            bc(aa, ne);
    ...
    function Ze(af, pe) {
        ...
        if ((pe & 65532) == 0) {
            ...
            kc = pe & ~7;
            if (((kc | 7) >>> 0) > ((Ya[(((ha) << 4) + (128 + 8)) >> 2] | 0) >>> 0)) fe(13, pe & 65532);
            aa = ((Ya[(((ha) << 4) + (128 + 4)) >> 2] | 0) + kc) | 0;
            qe = Vb(aa) | 0;
            aa = (aa + 4) | 0;
            ne = Vb(aa) | 0;
            if (!(ne & (1 << 12))) fe(13, pe & 65532);
            bf = pe & 3;
            Be = (ne >> 13) & 3;
            if ((af | 0) == 2) {
                if (!!(ne & (1 << 11)) | !(ne & (1 << 9))) fe(13, pe & 65532);
                if ((bf | 0) != (Ne | 0) | (Be | 0) != (Ne | 0)) fe(13, pe & 65532);
            } else {
                if ((ne & ((1 << 11) | (1 << 9))) == (1 << 11)) fe(13, pe & 65532);
                if (!(ne & (1 << 11)) | !(ne & (1 << 10))) {
                    if ((Be | 0) < (Ne | 0) | (Be | 0) < (bf | 0)) fe(13, pe & 65532);
                }
            }
            if (!(ne & (1 << 15))) {
                if ((af | 0) == 2) fe(12, pe & 65532);
                else fe(11, pe & 65532);
            }
            if (!(ne & (1 << 8))) {
                ne = ne | (1 << 8);
    ...
    function gf(ef, ff) {
        ...
        Ne = sa;
        if (ne & (1 << 12)) {
            if (!(ne & (1 << 11))) fe(13, ef & 65532);
            Be = (ne >> 13) & 3;
            if (ne & (1 << 10)) {
                if ((Be | 0) > (Ne | 0)) fe(13, ef & 65532);
            } else {
                bf = ef & 3;
                if ((bf | 0) > (Ne | 0)) fe(13, ef & 65532);
                if ((Be | 0) != (Ne | 0)) fe(13, ef & 65532);
            }
            if (!(ne & (1 << 15))) fe(11, ef & 65532);
            se = re(qe, ne) | 0;
            if ((ff >>> 0) > (se >>> 0)) fe(13, ef & 65532);
    ...
    function kf(af, Ne) {
        ...
        var Be = 0
            , ne = 0;
        if (((af | 0) == 4 | (af | 0) == 5) & ((Ya[(((af) << 4) + (128 + 0)) >> 2] | 0) & 65532) == 0) return;
    ...
    function mf(De, ef, ff, Je) {
        ...
        if (ne & (1 << 12)) {
            ...
            De = Ce >> 3;
            if ((Be | 0) < (Ne | 0) | (Be | 0) < (bf | 0)) fe(13, ef & 65532);
            if (!(ne & (1 << 15))) fe(11, ef & 65532);
            pe = qe >> 16;
    ...
    function tf(De, uf, vf) {
        ...
        Na = ff, Oa = Qa = 0, Sa = 8192;
        if (uf) {
            if (ta & 131072) xf = 256 | 262144 | 2097152 | 512 | 65536 | 16384;
            else xf = 256 | 262144 | 2097152 | 512 | 12288 | 65536 | 16384;
            if ((De | 0) == 0) xf = xf & 65535;
            Ed(wf, xf);
        }
        ve();
    }
    ...
    function yf(De, uf, vf) {
        ...
        if ((ef & 65532) == 0) fe(13, ef & 65532);
        e = oe(ef) | 0;
        if (!e) fe(13, ef & 65532);
        qe = Ga;
        ne = Ha;
        if (!(ne & (1 << 12)) | !(ne & (1 << 11))) fe(13, ef & 65532);
        Ne = sa;
        bf = ef & 3;
        if ((bf | 0) < (Ne | 0)) fe(13, ef & 65532);
        Be = (ne >> 13) & 3;
        if (ne & (1 << 10)) {
            if ((Be | 0) > (bf | 0)) fe(13, ef & 65532);
        } else {
            if ((Be | 0) != (bf | 0)) fe(13, ef & 65532);
        }
        if (!(ne & (1 << 15))) fe(11, ef & 65532);
        ...
        if ((bf | 0) == (Ne | 0)) {
            ...
            if ((zf & 65532) == 0) {
                ...
                if ((zf & 3) != (bf | 0)) fe(13, zf & 65532);
                e = oe(zf) | 0;
                if (!e) fe(13, zf & 65532);
                Re = Ga;
                Se = Ha;
                if (!(Se & (1 << 12)) | !!(Se & (1 << 11)) | !(Se & (1 << 9))) fe(13, zf & 65532);
                Be = (Se >> 13) & 3;
                if ((Be | 0) != (bf | 0)) fe(13, zf & 65532);
                if (!(Se & (1 << 15))) fe(11, zf & 65532);
        ...
        if (uf) {
            ...
            if ((Ne | 0) == 0) xf = xf | 12288;
            Ef = (ta >> 12) & 3;
            if ((Ne | 0) <= (Ef | 0)) xf = xf | 512;
            if ((De | 0) == 0) xf = xf & 65535;
            Ed(wf, xf);
        }
    }
    ...
    function Hf(pe, If) {
        ...
        if (ne & (1 << 12)) {
            if (!!(ne & (1 << 11)) & !!(ne & (1 << 10))) {} else {
                if ((Be | 0) < (Ne | 0) | (Be | 0) < (bf | 0)) return 0;
            }
        } else {
            Ce = (ne >> 8) & 15;
            switch (Ce | 0) {
    ...
    function Qg() {
        ...
        if (Ea & (16 | 32)) {
            ...
            if ((sg | 0) == -1 & (ra | 0) == 1 & ((aa | zg) & 3) == 0) {
                ...
                Og = Mg << 2;
                for (i = 0;
                    (i | 0) < (Mg | 0); i = (i + 1) | 0) Ya[(Ng + (i << 2)) >> 2] = Ya[(Rg + (i << 2)) >> 2];
                Ya[((6) << 2) >> 2] = (xg + Og) | 0;
                Ya[((7) << 2) >> 2] = (tg + Og) | 0;
                vg = (vg - Mg) | 0;
                Ya[((1) << 2) >> 2] = vg;
    ...
    function Sg() {
        ...
        if (Ea & (16 | 32)) {
            ...
            if ((sg | 0) == -1 & (ra | 0) == 1 & (aa & 3) == 0) {
                ...
                da = (Ya[((0) << 2) >> 2] | 0);
                for (i = 0;
                    (i | 0) < (Mg | 0); i = (i + 1) | 0) Ya[(Ng + (i << 2)) >> 2] = da;
                Og = Mg << 2;
                Ya[((7) << 2) >> 2] = (tg + Og) | 0;
                vg = (vg - Mg) | 0;
                Ya[((1) << 2) >> 2] = vg;
            ...
            Ud: for (;;) {
                ...
                case 157:
                    ...
                    if ((sa | 0) == 0) {
                        ...
                        if ((sa | 0) <= (Ef | 0)) cg = cg | 512;
                    }
                    Ed(da, cg & dc); {
                        if ((Ba | 0) != 0 & !!(ta & 512)) break bh;
                    };
                    break Ud;
                case 6:
                case 14:
                ...
                case 255:
                    ...
                    case 5:
                        ...
                        aa = (aa + 4) | 0;
                        dc = Bb(aa) | 0;
                        if ((pc | 0) == 3) sf(1, dc, da, ((Na + Oa - Qa) | 0));
                        else jf(dc, da);
                        break;
                    default:
                        Uc(6);
                ...
                case 235:
                    da = ((Wa[Oa] << 24) >> 24);
                    Oa = (Oa + 1) | 0;
                    Na = (Na + Oa - Qa + da) | 0, Oa = Qa = 0, Sa = 8192;
                    break Ud;
                case 233:
                    {
                        da = Wa[Oa >> 0] | (Wa[(Oa + 1) >> 0] << 8) | (Wa[(Oa + 2) >> 0] << 16) | (Wa[(Oa + 3) >> 0] << 24);
                ...
                case 112:
                    if (td() | 0) {
                        ...
                        Na = (Na + Oa - Qa + 1) | 0, Oa = Qa = 0, Sa = 8192;
                    }
                    break Ud;
                case 113:
                    if (!(td() | 0)) {
                ...
                case 226:
                    ...
                    b = b & 3;
                    if ((b | 0) == 0) cg = !((na | 0) == 0);
                    else if ((b | 0) == 1) cg = ((na | 0) == 0);
                    else cg = 1;
                    if (!!dc & !!cg) {
                        if (Ea & 256) {
                            Na = (Na + Oa - Qa + da) & 65535, Oa = Qa = 0, Sa = 8192;
                        } else {
                            Na = (Na + Oa - Qa + da) | 0, Oa = Qa = 0, Sa = 8192;
                        }
                    }
                ...
                case 15:
                    ...
                    case 143:
                        ...
                        if (zd(b & 15) | 0) Na = (Na + Oa - Qa + da) | 0, Oa = Qa = 0, Sa = 8192;
                        break Ud;
                    case 144:
                    case 145:
                    case 146:
                    ...
                    case 0:
                        ...
                        case 0:
                        case 1:
                            if ((pc | 0) == 0) da = (Ya[(((6) << 4) + (128 + 0)) >> 2] | 0);
                            else da = (Ya[(((7) << 4) + (128 + 0)) >> 2] | 0);
                            if ((hc >> 6) == 3) {
                                Xa[((hc & 7) << 2) >> 1] = da;
                            } else {
                                aa = gc(hc) | 0;
                    ...
                    case 189:
                        ...
                        if (b & 1) Ya[((fc) << 2) >> 2] = Sc((Ya[((fc) << 2) >> 2] | 0), dc) | 0;
                        else Ya[((fc) << 2) >> 2] = Qc((Ya[((fc) << 2) >> 2] | 0), dc) | 0;
                        break Ud;
                    case 175:
                        hc = Wa[Oa] | 0;
                        Oa = (Oa + 1) | 0;
                ...
                default:
                    ...
                    case 511:
                        ...
                        case 5:
                            ...
                            aa = (aa + 2) | 0;
                            dc = Bb(aa) | 0;
                            if ((pc | 0) == 3) sf(0, dc, da, ((Na + Oa - Qa) | 0));
                            else jf(dc, da);
                            break;
                        default:
                            Uc(6);
                    ...
                    case 383:
                        ...
                        Oa = (Oa + 1) | 0;
                        dc = zd(b & 15) | 0;
                        if (dc) Na = (Na + Oa - Qa + da) & 65535, Oa = Qa = 0, Sa = 8192;
                        break Ud;
                    case 450:
                        dc = ((cc() | 0) << 16) >> 16;
                        da = Nd() | 0;
                    ...
                    case 271:
                        ...
                        case 399:
                            da = cc() | 0;
                            if (zd(b & 15) | 0) Na = (Na + Oa - Qa + da) & 65535, Oa = Qa = 0, Sa = 8192;
                            break Ud;
                        case 320:
                        case 321:
                        case 322:
...
CPU_X86.prototype.exec = function lh(Da) {
    ...
    while (this.get_cycles() < nh) {
        ...
        if (Da > 2147483647) Da = 2147483647;
        try {
...
vh.prototype.ioport_read = function (aa) {
    ...
    if (aa == 112) {
        ...
        if (this.cmos_index == 10) this.cmos_data[10] ^= 128;
        else if (this.cmos_index == 12) this.cmos_data[12] = 0;
        return yh;
    }
};
...
zh.prototype.set_irq1 = function (Ah, lg) {
    ...
    Nc = 1 << Ah;
    if (lg) {
        if ((this.last_irr & Nc) == 0) this.irr |= Nc;
        this.last_irr |= Nc;
    } else {
        this.last_irr &= ~Nc;
    }
...
zh.prototype.get_priority = function (Nc) {
    ...
    if (Nc == 0) return -1;
    Bh = 7;
    while ((Nc & (1 << ((Bh + this.priority_add) & 7))) == 0) Bh--;
    return Bh;
};
...
zh.prototype.intack = function (Ah) {
    if (this.auto_eoi) {
        if (this.rotate_on_auto_eoi) this.priority_add = (Ah + 1) & 7;
    } else {
        this.isr |= (1 << Ah);
    }
    if (!(this.elcr & (1 << Ah))) this.irr &= ~(1 << Ah);
};
zh.prototype.ioport_write = function (aa, da) {
    ...
    if (aa == 0) {
        if (da & 16) {
            ...
            this.init_state = 1;
            this.init4 = da & 1;
            if (da & 2) throw "single mode not supported";
            if (da & 8) throw "level sensitive irq not supported";
        } else if (da & 8) {
            if (da & 2) this.read_reg_select = da & 1;
            if (da & 64) this.special_mask = (da >> 5) & 1;
        } else {
            switch (da) {
            case 0:
            case 128:
            ...
            case 160:
                ...
                if (da == 160) this.priority_add = (this.priority_add + 1) & 7;
                break;
            case 96:
            case 97:
            case 98:
...
zh.prototype.ioport_read = function (Dh) {
    ...
    aa = Dh & 1;
    if (aa == 0) {
        if (this.read_reg_select) yh = this.isr;
        else yh = this.irr;
    } else {
        yh = this.imr;
    }
...
Kh.prototype.get_next_transition_time = function () {
    ...
    switch (this.mode) {
        ...
        case 0:
        case 1:
            if (d < this.count) Nh = this.count;
            else return -1;break;
    case 2:
            ic = (d / this.count) * this.count;
        if ((d - ic) == 0 && d != 0) Nh = ic + this.count;
        else Nh = ic + this.count + 1;
        break;
    case 3:
            ic = (d / this.count) * this.count;Oh = ((this.count + 1) >> 1);
        if ((d - ic) < Oh) Nh = ic + Oh;
        else Nh = ic + this.count;
        break;
    case 4:
        case 5:
            if (d < this.count) Nh = this.count;
        elseif(d == this.count) Nh = this.count + 1;
        else return -1;
        break;
    }
...
Ih.prototype.ioport_read = function (aa) {
    ...
    case 4:
    case 5:
        if (s.rw_state & 1) yh = s.latched_count >> 8;
        else yh = s.latched_count & 255;
        s.rw_state ^= 1;
        break;
    }
    return yh;
...
Rh.prototype.ioport_write = function (aa, da) {
    ...
    case 2:
            if ((this.fcr ^ da) & 1) {
            da |= 4 | 2;
        }if (da & 4) this.tx_fifo = "";
        if (da & 2) this.rx_fifo = "";this.fcr = da & 1;
        break;
    case 3:
            this.lcr = da;
        break;
...
bi.prototype.identify = function () {
    ...
    ci(57, gi);
    ci(58, gi >> 16);
    if (this.mult_sectors) ci(59, 256 | this.mult_sectors);
...
bi.prototype.sector_read_cb = function () {
    ...
    if (this.nsector == 0) li = this.sector_read_cb_end.bind(this);
    else li = this.sector_read.bind(this);
...
function vi(ph, wi, xi) {
    if (ph.indexOf("%d") < 0) throw "Invalid URL";
    if (xi <= 0 || wi <= 0) throw "Invalid parameters";
...
vi.prototype.add_block = function (yi, sh, Mg) {
    ...
    if (typeof sh == "string") {
        for (i = 0; i < Mg; i++) Ji[i] = sh.charCodeAt(i) & 255;
    } else {
        for (i = 0; i < Mg; i++) Ji[i] = sh[i];
    }
};
...
vi.prototype.read_async = function (ji, Ji, n, Ki) {
    if ((ji + n) > this.nb_sectors) return -1;
    this.sector_num = ji;
    this.sector_buf = Ji;
    this.sector_index = 0;
    this.sector_count = n;
...
Li.prototype.buffer_full = function () {
    ...
    Qi = this.boundary << 8;
    if (kc < Qi) Pi = Qi - kc;
    else Pi = (this.stop - this.start) - (kc - Qi);
    return (Pi < (1514 + 4));
};
Li.prototype.receive_packet = function (Ji) {
    ...
    var Vi, i;
    hi = Ji.length;
    if (this.cmd & 1 || this.buffer_full() || hi < 6) return;
    if (this.rxcr & 16) {} else {
        if (Ji[0] == 255 && Ji[1] == 255 && Ji[2] == 255 && Ji[3] == 255 && Ji[4] == 255 && Ji[5] == 255) {
            if (!(this.rxcr & 4)) return;
        } else if (Ji[0] & 1) {
            if (!(this.rxcr & 8)) return;
            Ti = Wi(Ji);
            if (!(this.mult[Ti >> 3] & (1 << (Ti & 7)))) return;
    ...
    Ri = hi + 4;
    Si = kc + ((Ri + 4 + 255) & ~255);
    if (Si >= this.stop) Si -= (this.stop - this.start);
    this.rsr = 1;
    if (Ji[0] & 1) this.rsr |= 32;
    aa = kc & 32767;
    if (aa >= 16384) {
        Ui[aa] = this.rsr & 255;
        Ui[aa + 1] = (Si >> 8) & 255;
    ...
    kc += 4;
    while (hi > 0) {
        if (kc >= this.stop) break;
        Mg = Math.min(hi, this.stop - kc);
        if (Vi < Ji.length) Mg = Math.min(Mg, Ji.length - Vi);
        Mg = Math.min(Mg, 16384 - (kc & 16383));
        aa = kc & 32767;
        if (aa >= 16384) {
            if (Vi < Ji.length) {
                for (i = 0; i < Mg; i++) Ui[aa + i] = Ji[Vi + i];
            } else {
                for (i = 0; i < Mg; i++) Ui[aa + i] = 0;
            }
        }
        Vi += Mg;
        kc += Mg;
        if (kc == this.stop) kc = this.start;
        hi -= Mg;
    }
    this.curpag = Si >> 8;
    this.isr |= 1;
